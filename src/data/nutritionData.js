...
export const curateIngredients = [
    ...
    { id: 'ing_white_bread', name: 'Pan Blanco (rebanada)', category: 'Panes', macros: { kcal: 270, protein: 8.5, carbs: 52, fat: 1.6 }, micros: { b1: 0.1, iron: 1.2 }, unit: 'unidad', portionWeight: 30 },
    ...
    // --- FRUTAS ---
    { id: 'ing_banana', name: 'Plátano (unidad)', category: 'Frutas', macros: { kcal: 89, protein: 1.1, carbs: 23, fat: 0.3 }, micros: { potassium: 358, vitaminB6: 0.4 }, unit: 'unidad', portionWeight: 120 },
    ...
    { id: 'ing_orange', name: 'Naranja (unidad)', category: 'Frutas', macros: { kcal: 47, protein: 0.9, carbs: 12, fat: 0.1 }, micros: { vitaminC: 53, folate: 30 }, unit: 'unidad', portionWeight: 150 },
    { id: 'ing_peach', name: 'Melocotón / Nectarina (unidad)', category: 'Frutas', macros: { kcal: 40, protein: 0.9, carbs: 9.5, fat: 0.3 }, micros: { vitaminA: 16, vitaminC: 6.6 }, unit: 'unidad', portionWeight: 150 },
