...
import { Plus, Save, Calendar, Trash2, ChevronRight, Search, Edit2, X, Copy, AlertCircle, ArrowRightLeft, BookmarkPlus, XCircle } from 'lucide-react';
    ...
    return (
        <div className="max-w-6xl mx-auto relative">
            ...
            <AnimatePresence>
                {activeSlot && (
                    <>
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[60] bg-slate-900/20 backdrop-blur-sm" onClick={() => setActiveSlot(null)} />
                        <motion.div
                            initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }}
                        ...
                        >
                            <div className="p-6 border-b border-slate-100 shrink-0">
                                ...
                                <p className="text-sm text-slate-400 mb-4">Para {activeSlot}</p>
                                <input
                                    type="text"
